...
class PublicSubmissions(SQLModel, table=True):
    ...
    face_mesh: str = Field(nullable=True, default=None)  # JSON string of face mesh landmarks
    face_embedding: str = Field(nullable=True, default=None)  # JSON string of 512-d face embedding
